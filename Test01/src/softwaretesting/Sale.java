...
public class Sale {
    ...
    int x1 = 168, x2 = 120, x3 = 5;// 白酒、红酒和啤酒的单价分别为168元/瓶、 120元/瓶、5元/瓶。
	 ...
	 int w1 = 20000, w2 = 45000;
	 //2万元以下(含)：4%；2万元(不含)～4.5万元(含)：1%；4.5万元以上(不含)：0.5%。(分段计算利润)
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (e.getSource() == button1) {
					...
					if (((Integer.parseInt(str1) >= b1) && (Integer
						...
						if(!((Integer.parseInt(str2) >= b2) && (Integer
								.parseInt(str2) <= a2))){
							text2.setText(str4);
						}
						if(!((Integer.parseInt(str3) >= b3) && (Integer
								.parseInt(str3) <= a3))){
							text3.setText(str4);
						}				
						ta1.setFont(f2);
