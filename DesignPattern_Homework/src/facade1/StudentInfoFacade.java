...
public class StudentInfoFacade {
	 ...
	 //
	 private final String TUITION = "Tuition.txt";
  ...
  public String extractTuitionInfo(){
        ...
        Iterator tuitionIterator = tui.iterator();
	      ...
	      while (tuitionIterator.hasNext()) {
                  ...
                  String tuitionTitle = tuitionModel. getTuitionTitle().trim();
                  String tuitionNum = tuitionModel.getTuitionNum().trim();

                  allInfo = allInfo +" " + firstNm+" "+ lastNm+ " " + studNum+ " "+ tuitionTitle+" "+tuitionNum+"\n";
         }
            return allInfo;
  }
}
