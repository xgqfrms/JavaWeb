...
public class D2 {
	...
	private class SwingAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			str2 = textField_2.getText();
//			str3 = passwordField.toString();
//			str4 = passwordField_1.toString();
			...
			JOptionPane.showMessageDialog(null, "你提交的信息,正在处理中......",
					"注意!提交后的信息不可修改!", 0);
			 if (a && b && c && d) {
			 // str1 = textField.getText() + textField_2.getText();
			 // File file = new File();//写入test.txt文件
			 JOptionPane.showMessageDialog(null, "欢迎, "+str1.toUpperCase()+" 加入 X.site团队 !",
			 "注册成功!", 0);
			 }else{
