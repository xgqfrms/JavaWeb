...
public class TriangleDistinguish {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TriangleDistinguish window = new TriangleDistinguish();
	...
	private void initialize() {
		frame = new JFrame("TriangleDistinguish   Made by xgqfrms");
